  ...
  return (
    <div className="flex flex-col gap-6 p-4 md:p-6 pb-24 max-w-2xl mx-auto">
      <div className="flex items-center gap-4">
        ...
        <div>
          <h1 className="text-2xl font-black tracking-tighter">Coin Catch</h1>
          <p className="text-[10px] font-bold text-slate-400 uppercase tracking-widest">Agilidad Financiera</p>
        </div>
      </div>
